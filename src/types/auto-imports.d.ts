...
declare global {
  ...
  // @ts-ignore
  export type { CRUDCOmponentType, Permissions, UxCRUDColumns, UxCRUDTimeCol, UxCRUDTAGCol, UxCRUDProps, EXPORT_UxCRUDMethods, FetchGetList, Actions, UxCRUDActions, ActionCommonType, ActionDel, ActionEdit, SearchFieldProps, AddButtons } from '../components/CRUD/UxCRUD/types'
